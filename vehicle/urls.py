...
from vehicle.views import CreateVehicleType,CreateVehicleModel,CreateVehicleBrand,CreateVehiclePrice,CreateCurrency,ListVehicleModel,ListVehiclePrice,ListCurrency,ListVehicleBrand,ListVehicleType
